...
# TODO: check if 0xC0000000 is right

# gem5-bridge exit signifying that after_boot.sh is running
# printf "In workloads after_boot.sh...\n"
# gem5-bridge --addr 0xC0000000 exit # TODO: Make this a specialized event.
...
#         if ! gem5-bridge --addr=0xC0000000 readfile > /tmp/script; then
...
#             if ! gem5-bridge --addr=0xC0000000 exit; then
...
#             rm -f /tmp/script
#             gem5-bridge --addr=0xC0000000 exit
#         fi
#     fi
# fi
